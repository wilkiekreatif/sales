...
//untuk fungsi login/register
Auth::routes(['register' => false]);
// Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home');

// routing group untuk authentication agar tidak semua route menggunakan middleware, namun link pada setiap URL tidak menggunakan admin, karena sudah di prefix
// Route::prefix('admin')->middleware('auth')->group(function(){
    
// });

// routing group seperti diatas namun tanpa menggunakan prefix
